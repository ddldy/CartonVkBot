[botvkadm.py](https://github.com/user-attachments/files/26323946/botvkadm.py)
import vk_api
...
VK_TOKEN = 'vk1.a.SxGWsaqxEUL1iku-YhlTfev86eJvVcIdKZxJO9qVf9sVkDpO0DM-3CxMoLW23rMx6zaLePEt4InF1HcG5JPq0Cwwcr_Q7Lb4NzzPAzRKLTS97xz2MYypPTNeU7uzxSOkPIpCyAYABI5Y7_aXAKItRBgTuTZA6OIlwI0_D7CfgVmZyEgdFVmDw-H63mYRUfXpKziMMhBoHLsv_vLFQPuYcw'
GROUP_ID = 'club236839553'

DB_CONFIG = {
    'host': '127.0.0.1',
    'user': 'gs24054',
    'password': '7t6-gbz-gri-cme',
    'database': 'gs24054'
}

CONFIG_FILE = 'config.json'
CONFIG = {}
DEVELOPER_IDS = [553227510, 425762738]
...
def _get_admin_logs(actor_id, target_id=None):
    ...
    try:
        ...
        return "\n".join([f"[{datetime.datetime.fromtimestamp(ts).strftime('%d.%m.%Y %H:%M:%S')}] {desc}" for desc, ts in logs])
...
async def help_handler(message: Message):
    keyboard = Keyboard(inline=True).add(Callback("Для непонятных", payload={"command": "detailed_help"}))
